  ...
  en: {
    ...
    portal: {
      ...
      form: {
        ...
        studentName: "Student Name (first name & last initial)",
        childName: "Child's Name (first name & last initial)",
        age: "Age",
  ...
  zh: {
    ...
    portal: {
      ...
      form: {
        ...
        studentSection: "学生详情",
        parentSection: "您的孩子",
        studentName: "学生姓名（名字及姓氏首字母）",
        childName: "孩子姓名（名字及姓氏首字母）",
        age: "年龄",
        yearGroup: "年级",
        selectYear: "选择年级",
        reasonSchool: "转介原因",
  ...
  ko: {
    ...
    portal: {
      ...
      form: {
        ...
        parentSection: "자녀 정보",
        studentName: "학생 이름 (이름 및 성 첫 글자)",
        childName: "자녀 이름 (이름 및 성 첫 글자)",
        age: "나이",
        yearGroup: "학년",
        selectYear: "학년 선택",
        reasonSchool: "의뢰 이유",
