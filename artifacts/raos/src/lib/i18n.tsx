...
export const translations = {
  en: {
    ...
    landing: {
      ...
      schoolsParents: "Schools & Parents",
      schoolsParentsDesc: "Submit a referral or make an enquiry",
      assessmentStaff: "Assessment Staff",
      assessmentStaffDesc: "Sign in to the RAOS platform",
      authorised: "Authorised access only. All activity is logged and monitored.",
      copyright: "ReMynd Pty Ltd · Confidential",
    },
  ...
  zh: {
    ...
    landing: {
      ...
      schoolsParents: "学校与家长",
      schoolsParentsDesc: "提交转介或咨询",
      assessmentStaff: "评估人员",
      assessmentStaffDesc: "登录 RAOS 平台",
      authorised: "仅限授权访问。所有活动均有记录和监控。",
      copyright: "ReMynd Pty Ltd · 保密",
    },
  ...
  ko: {
    ...
    landing: {
      ...
      schoolsParents: "학교 및 부모",
      schoolsParentsDesc: "의뢰서 제출 또는 문의하기",
      assessmentStaff: "평가 직원",
      assessmentStaffDesc: "RAOS 플랫폼에 로그인",
      authorised: "승인된 접근만 가능합니다. 모든 활동이 기록되고 모니터링됩니다.",
      copyright: "ReMynd Pty Ltd · 기밀",
    },
