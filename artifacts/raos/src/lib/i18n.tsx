...
export const translations = {
  en: {
    ...
    compliance: {
      ...
      policies: {
        warningNote: "These are internal placeholder records only. No policy documents have been generated. Do not display to users, parents or schools until legally reviewed and approved.",
        statuses: {
  ...
  zh: {
    ...
    compliance: {
      ...
      policies: {
        warningNote: "这些仅为内部占位记录。未生成任何政策文件。在经过法律审查和批准之前，请勿向用户、家长或学校显示。",
        statuses: {
          not_started: "未开始",
          drafting: "起草中",
  ...
  ko: {
    ...
    compliance: {
      ...
      policies: {
        warningNote: "이것들은 내부 자리 표시자 기록뿐입니다. 정책 문서가 생성되지 않았습니다. 법적 검토 및 승인이 완료될 때까지 사용자, 학부모 또는 학교에 표시하지 마십시오.",
        statuses: {
          not_started: "미시작",
          drafting: "초안 작성 중",
