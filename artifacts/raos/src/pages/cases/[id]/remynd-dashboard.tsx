...
const DOMAIN_LABELS: Record<string, string> = {
  ...
  attention_problems: "Attention Problems",
  ...
  // BASC-3 SRP subscales
  attitude_to_school: "Attitude to School",
  attitude_to_teachers: "Attitude to Teachers",
  sensation_seeking: "Sensation Seeking",
  locus_of_control: "Locus of Control",
  social_stress: "Social Stress",
  sense_of_inadequacy: "Sense of Inadequacy",
  relations_with_parents: "Relations with Parents",
  ...
  organization_of_materials: "Organization of Materials",
};
