...
export default function JoinMeetingPage() {
  ...
  function startMeeting() {
    ...
    if (redirectUrl) {
      // External URL (Zoom, Teams, etc.) — navigate directly
    ...
    const fragment = [
      ...
      `config.subject="${sessionLabel}"`,
    ].join("&");
    window.location.href = `https://meet.ffmuc.net/${room}#${fragment}`;
  }
