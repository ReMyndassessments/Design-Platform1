      ...
      <div className="md:w-1/2 relative z-10 flex flex-col justify-center px-10 py-14" style={{ background: "#f0f4fb" }}>
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Student Case Portal */}
            <Link href="/my-portal">
              <div className="group flex flex-col rounded-2xl border border-indigo-500/40 bg-[#1a2744] hover:border-indigo-500/60 hover:bg-[#1f2f52] hover:shadow-[0_0_32px_rgba(99,102,241,0.22)] transition-all duration-300 overflow-hidden cursor-pointer">
            ...
            <Link href="/portal?tab=school">
              <div className="group relative flex items-center gap-4 rounded-2xl border border-[#243a5e] bg-[#1a2744] hover:border-indigo-500/60 hover:bg-[#1f2f52] hover:shadow-[0_0_32px_rgba(99,102,241,0.22)] transition-all duration-300 overflow-hidden px-5 py-4 cursor-pointer">
            ...
            <Link href="/portal?tab=parent">
              <div className="group relative flex items-center gap-4 rounded-2xl border border-[#243a5e] bg-[#1a2744] hover:border-teal-500/60 hover:bg-[#1f2f52] hover:shadow-[0_0_32px_rgba(20,184,166,0.22)] transition-all duration-300 overflow-hidden px-5 py-4 cursor-pointer">
            ...
            <Link href="/partner-schools">
              <div className="group relative flex items-center gap-4 rounded-2xl border border-[#243a5e] bg-[#1a2744] hover:border-violet-500/60 hover:bg-[#1f2f52] hover:shadow-[0_0_32px_rgba(139,92,246,0.22)] transition-all duration-300 overflow-hidden px-5 py-4 cursor-pointer">
            ...
            <Link href="/assessment-services">
              <div className="group relative flex items-center gap-4 rounded-2xl border border-amber-500/30 bg-[#1a2744] hover:border-amber-500/60 hover:bg-[#1f2f52] hover:shadow-[0_0_32px_rgba(245,158,11,0.22)] transition-all duration-300 overflow-hidden px-5 py-4 cursor-pointer">
