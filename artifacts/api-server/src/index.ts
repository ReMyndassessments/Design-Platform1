...
import { SDQ_PARENT_FORM, SDQ_TEACHER_FORM, SDQ_SR_FORM, GHQ12_FORM, SMFQ_FORM, PSC_FORM, GAD7_FORM, PHQ9_FORM, PHQ9A_FORM, PSS10_FORM, DASS21_FORM, RSES_FORM, WHO5_FORM, AUDIT_FORM, CABS_FORM } from "./lib/opentools.js";
...
const CANONICAL_TOOLS: (typeof assessmentToolsTable.$inferInsert)[] = [
  ...
  {
    id: "SDQ-P",
    name: "Strengths and Difficulties Questionnaire – Parent (Ages 3–16)",
    category: "behavior",
    description: "Parent-completed 25-item screening questionnaire for emotional and behavioural problems in children aged 3–16. Covers five subscales: Emotional Symptoms, Conduct Problems, Hyperactivity/Inattention, Peer Relationship Problems, and Prosocial Behaviour. Free to use from sdqinfo.org.",
    isRemyndOwned: false,
    respondentTypes: ["parent"],
    scoringType: "manual",
    domains: ["behavior", "social-emotional"],
    formItems: SDQ_PARENT_FORM,
    scoringConfig: null,
  },
  {
    id: "SDQ-T",
    name: "Strengths and Difficulties Questionnaire – Teacher (Ages 3–16)",
    category: "behavior",
    description: "Teacher-completed 25-item screening questionnaire for emotional and behavioural problems in children aged 3–16. Covers the same five subscales as the parent version. Free to use from sdqinfo.org.",
    isRemyndOwned: false,
    respondentTypes: ["teacher1", "teacher2"],
    scoringType: "manual",
    domains: ["behavior", "social-emotional"],
    formItems: SDQ_TEACHER_FORM,
    scoringConfig: null,
  },
  {
    id: "SDQ-SR",
    name: "Strengths and Difficulties Questionnaire – Self-Report (Ages 11–17)",
    category: "behavior",
    description: "Self-completed 25-item screening questionnaire for young people aged 11–17. Uses first-person phrasing across the same five subscales. Free to use from sdqinfo.org.",
    isRemyndOwned: false,
    respondentTypes: ["self"],
    scoringType: "manual",
    domains: ["behavior", "social-emotional"],
    formItems: SDQ_SR_FORM,
    scoringConfig: null,
  },
  {
    id: "GHQ-12",
...
const CANONICAL_BATTERIES: (typeof batteriesTable.$inferInsert)[] = [
  ...
  },
  {
    ...
    toolIds: ["SDQ-P", "SDQ-T", "SDQ-SR", "GHQ-12", "SMFQ", "PSC", "GAD-7", "PHQ-9", "PHQ-9A", "PSS-10", "DASS-21", "RSES", "WHO-5", "AUDIT", "CABS"],
    isRemyndOwned: false,
    domains: ["behavior", "social-emotional"],
