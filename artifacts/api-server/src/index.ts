...
const CANONICAL_TOOLS: (typeof assessmentToolsTable.$inferInsert)[] = [
  ...
  },
  {
    ...
    category: "ReMynd Admin Forms",
    description: "A brief 5\u20137 minute student self-report questionnaire used as an initial intake to build a tutoring learning profile. Covers learning preferences, attention and study habits, academic confidence, motivation, and goals. 26 items across 5 domains.",
    isRemyndOwned: true,
    respondentTypes: ["self"],
    scoringType: "manual",
