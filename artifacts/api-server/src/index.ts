...
import { SNAP_IV_FORM, ABC_AUT_FORM, ASRS_AUT_FORM, SEDQ_FORM, SCAS_P_FORM, HIQ_FORM, LASA_FORM, DST_FORM } from "./tools/external-tool-forms.js";
...
const CANONICAL_TOOLS: (typeof assessmentToolsTable.$inferInsert)[] = [
  ...
  // ── External tools with full form definitions ────────────────────────────────
  {
    id: "SNAP-IV",
    name: "SNAP-IV 26",
    category: "behavior",
    description: "A 26-item parent and teacher rating scale based directly on DSM-IV criteria for ADHD and ODD, widely used to screen for and monitor attention, hyperactivity, and oppositional defiant symptoms in children and adolescents.",
    isRemyndOwned: false,
    respondentTypes: ["parent", "teacher1", "teacher2"],
    scoringType: "manual",
    domains: ["inattention", "hyperactivity_impulsivity", "odd"],
    scoringConfig: null,
    formItems: SNAP_IV_FORM,
  },
  {
    id: "ABC-AUT",
    name: "Autism Behavior Checklist (ABC)",
    category: "behavior",
    description: "A 57-item checklist assessing autism-related behaviors across five subscales: sensory, relating, body and object use, language, and social and self-help. Completed by a parent or teacher familiar with the child.",
    isRemyndOwned: false,
    respondentTypes: ["parent", "teacher1"],
    scoringType: "manual",
    domains: ["language", "body_object_use", "sensory", "relating"],
    scoringConfig: null,
    formItems: ABC_AUT_FORM,
  },
  {
    id: "ASRS-AUT",
    name: "Autism Spectrum Rating Scale (ASRS — 6–18)",
    category: "behavior",
    description: "A norm-referenced rating scale screening for autism spectrum disorder symptoms across multiple informants and age groups, assessing social/communication deficits, unusual behaviors, and self-regulation difficulties.",
    isRemyndOwned: false,
    respondentTypes: ["parent", "teacher1"],
    scoringType: "manual",
    domains: ["social_communication", "rrb", "sensory", "language", "attention_ef", "behavioral_regulation"],
    scoringConfig: null,
    formItems: ASRS_AUT_FORM,
  },
  {
    id: "SEDQ",
    name: "Social-Emotional Development Questionnaire (SEDQ)",
    category: "social-emotional",
    description: "A screening questionnaire assessing social communication, emotional understanding, behavioral flexibility, and interaction patterns in children and adolescents, completed by parents or teachers.",
    isRemyndOwned: false,
    respondentTypes: ["parent", "teacher1", "teacher2"],
    scoringType: "manual",
    domains: ["social_interaction", "communication", "language_development", "imagination_play", "behavioral_rigidity", "social_understanding", "nonverbal_motor", "adaptive_skills"],
    scoringConfig: null,
    formItems: SEDQ_FORM,
  },
  {
    id: "SCAS-P",
    name: "Spence Children's Anxiety Scale — Parent Version (SCAS-P)",
    category: "social-emotional",
    description: "The parent-report version of the SCAS, assessing anxiety symptoms across six domains in children aged 6–18: separation anxiety, social phobia, OCD, panic/agoraphobia, generalized anxiety, and physical injury fears.",
    isRemyndOwned: false,
    respondentTypes: ["parent"],
    scoringType: "manual",
    domains: ["generalized_anxiety", "separation_anxiety", "social_phobia", "panic_agoraphobia", "ocd", "physical_injury_fears"],
    scoringConfig: null,
    formItems: SCAS_P_FORM,
  },
  {
    id: "HIQ",
    name: "Hyperacusis Impact Questionnaire (HIQ)",
    category: "adaptive",
    description: "A 15-item self-report questionnaire measuring the functional and emotional impact of hyperacusis (extreme sound sensitivity) on daily life, including avoidance behaviors, emotional distress, and activity limitations.",
    isRemyndOwned: false,
    respondentTypes: ["self", "parent"],
    scoringType: "manual",
    domains: ["emotional_response", "behavioral_avoidance", "functional_impact", "social_impact", "cognitive_burden"],
    scoringConfig: null,
    formItems: HIQ_FORM,
  },
  {
    id: "LASA",
    name: "Learning Ability Screening Assessment (LASA)",
    category: "achievement",
    description: "A 30-item teacher and parent completed screening tool across six domains — reading, writing, math, emotional regulation, listening, and attention — identifying students at risk for learning difficulties.",
    isRemyndOwned: false,
    respondentTypes: ["teacher1", "teacher2", "parent"],
    scoringType: "manual",
    domains: ["reading", "spelling_writing", "math_logic", "emotional_regulation", "listening_language", "attention_ef"],
    scoringConfig: null,
    formItems: LASA_FORM,
  },
  {
    id: "DST",
    name: "Dyslexia Screening Tool (DST)",
    category: "achievement",
    description: "A standardized screening instrument identifying children and adults at risk for dyslexia across developmental history, learning behaviors, and cognitive processing patterns including phonological awareness and reading fluency.",
    isRemyndOwned: false,
    respondentTypes: ["student", "teacher1"],
    scoringType: "manual",
    domains: ["developmental_risk", "learning", "vision_reading", "hearing_speech", "writing_motor", "math_time", "memory_cognition", "behavior_health"],
    scoringConfig: null,
    formItems: DST_FORM,
  },
];
