...
async function createWorkshopTables() {
  try {
    ...
    await db.execute(sql`ALTER TABLE workshop_registrations
      ADD COLUMN IF NOT EXISTS job_title TEXT,
      ADD COLUMN IF NOT EXISTS professional_role_other TEXT,
      ADD COLUMN IF NOT EXISTS city TEXT,
      ADD COLUMN IF NOT EXISTS school_type TEXT,
      ADD COLUMN IF NOT EXISTS school_size TEXT,
      ADD COLUMN IF NOT EXISTS areas_of_interest JSONB,
