...
// ── Static product definitions (mirrors src/lib/products.ts in the frontend) ──
...
export const PRODUCTS_LIST: AssessmentProductDef[] = [
  // Schools
  { id: "comprehensive-psych-profile", name: "Comprehensive Psychoeducational Profile & Support Plan", market: "schools",
  ...
  { id: "school-snapshot", name: "School Wellbeing & Learning Snapshot", market: "schools",
    toolIds: ["RCS-80","RASR","RERMS","RSSC","RSCP","SDQ-P","SDQ-P11","SDQ-T","SDQ-T11","SDQ-SR","SDQ-SR18","PSC"] },
  { id: "focused-support", name: "Focused Student Support Assessment", market: "schools",
  ...
  { id: "sen-learning-support", name: "Learning Support Decision System (SEN)", market: "schools",
    toolIds: ["RCS-80","RCEP-CORE","REFI","RFII","RARPS","RASR","SCAS","RCADS","BYI2","RSCA","EFA"] },
  { id: "boarding-wellbeing", name: "Boarding Student Adjustment & Wellbeing", market: "schools",
    toolIds: ["BSPP","RERMS","RSCP","RFII","WHO-5","PSS-10","SDQ-SR","SDQ-SR18","GAD-7"] },
  // Parents
  { id: "why-struggling", name: "Why Is My Child Struggling?", market: "parents",
    toolIds: ["RCS-80","RASR","RSCP","RARPS","RFII","INTAKE","RCADS","BYI2"] },
  { id: "ef-coaching", name: "Executive Function Coaching Assessment", market: "parents",
    toolIds: ["REFI","RASR","BRIEF2-SR"] },
  { id: "emotional-wellbeing", name: "Emotional Wellbeing Check", market: "parents",
    toolIds: ["RERMS","DASS-21","GAD-7","PHQ-9"] },
  { id: "school-readiness", name: "School Readiness / Transition Assessment", market: "parents",
    toolIds: ["RSSC","RERMS","REFI","SDQ-SR","SDQ-SR18","WHO-5"] },
  // Corporate
  { id: "employee-wellbeing", name: "Employee Wellbeing & Burnout Screen", market: "corporate",
    toolIds: ["PSS-10","DASS-21","RSES","GHQ-12"] },
  { id: "leadership-profiling", name: "Leadership / High-Performer Profiling", market: "corporate",
    toolIds: ["REFI","RERMS","RSES"] },
  { id: "graduate-readiness", name: "Graduate / Intern Readiness Assessment", market: "corporate",
    toolIds: ["REFI","RSCA","RSES","GHQ-12"] },
  // Universities
  { id: "intl-student", name: "International Student Adjustment Assessment", market: "universities",
    toolIds: ["RERMS","PSS-10","DASS-21","RSCA","WHO-5","RSES"] },
  { id: "academic-risk", name: "Academic Risk Early Warning System", market: "universities",
    toolIds: ["RCS-80","RCEP-CORE","REFI","RFII","RARPS","RERMS","RASR"] },
  // Specialized
  { id: "cdp", name: "ReMynd Child Development Profile (CDP)", market: "specialized",
    toolIds: ["CDP-CL","CDP-SI","CDP-SR","CDP-CI"] },
  { id: "hidden-struggler", name: "Hidden Struggler Assessment", market: "specialized",
    toolIds: ["REFI","RFII","RSCA","RERMS","RCADS","BYI2"] },
  { id: "underachievement", name: "Underachievement Profile", market: "specialized",
    toolIds: ["RCS-80","RCEP-CORE","RASR","RARPS","REFI","RFII"] },
  { id: "digital-distraction", name: "Digital Distraction & Focus Assessment", market: "specialized",
...
router.get("/cases/:caseId/product-dashboard", authMiddleware, async (req, res) => {
  ...
  // Fetch tool metadata for all relevant tools
  ...
  // Also fetch all tool names for tools we don't have in DB (edge case)
...
router.patch("/cases/:caseId/product-tool-overrides", authMiddleware, async (req, res) => {
  if (!isAdminLike(req.userRole) && req.userRole !== "psychometrician") {
